import { EditorState, Facet, combineConfig, StateField } from '@codemirror/state';
...
class TextState extends LineBasedState {
    ...
    shouldUpdate(update) {
        ...
        if (this.languageChanged(update)) {
            return true;
        }
        return false;
    }
    ...
    languageChanged(update) {
        return (update.startState.facet(EditorState.languageData) !== update.state.facet(EditorState.languageData))
    }
    themeChanged() {
